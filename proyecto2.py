#Este programa tiene la finalidad de calcular el retorno y la varianza de un portafolio de activos dada la rentabilidad de cada uno de ellos,
#su matriz de covarianzas y los pesos de cada uno de los activos en el portafolio.
#Por otra parte, también realiza cálculos para obtener el vector de pesos que genera el portafolio de máximo retorno,
#de mínima varianza y por último el máximo ratio de sharpe.
